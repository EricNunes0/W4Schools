import { TutorialSectionsSpan } from "./TutorialSectionsSpan";

export default function TutorialSectionsParagraphSpan(prop) {
    ...
    return (
        <TutorialSectionsSpan data-bold = {bold} style = {style}>{text}</TutorialSectionsSpan>
    );
};